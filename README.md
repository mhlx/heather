...
|  <i class="fas fa-search"></i>  |  打开搜索框   | <kbd>Alt</kbd> <kbd>Enter</kbd>
|  <i class="fas fa-cog"></i>  |  打开主题配置   |   
|  <i class="fas fa-expand"></i>  |  进入全屏模式   | <kbd>Ctrl</kbd> <kbd>Enter</kbd>   |
|  <i class="fas fa-compress"></i>  |  退出全屏模式   |  <kbd>Esc</kbd> | 
...
|  <i class="fas fa-heading"></i>  |  插入heading   |  <kbd>Ctrl</kbd> <kbd>H</kbd>   |
|  <i class="fas fa-bold"></i>  |  文字加粗   |   <kbd>Ctrl</kbd> <kbd>B</kbd>   |    
|  <i class="fas fa-italic"></i>  |  文字倾斜  |   <kbd>Ctrl</kbd> <kbd>I</kbd>   |
|  <i class="fas fa-quote-left"></i>  |  引用   | <kbd>Ctrl</kbd> <kbd>Q</kbd>   |
|  <i class="fas fa-strikethrough"></i>  |  将文字标记为删除   |
|  <i class="fas fa-link"></i>  |  插入超链接   | <kbd>Ctrl</kbd> <kbd>L</kbd>   |
|  <i class="fas fa-code"></i>  |  插入代码(inline)   | 
|  <i class="fas fa-file-code"></i>  |  插入代码块   | <kbd>Alt</kbd> <kbd>B</kbd> |
|  <i class="far fa-square"></i>  |  插入todo(未完成)   | <kbd>Alt</kbd> <kbd>U</kbd> |
|  <i class="far fa-check-square"></i>  |  插入todo(已完成)   | <kbd>Alt</kbd> <kbd>I</kbd>| 
|  <i class="fas fa-table"></i>  |  插入表格   | <kbd>Alt</kbd> <kbd>T</kbd> |
|  <i class="fas fa-undo"></i>  |  undo   |   <kbd>Ctrl</kbd> <kbd>Z</kbd>   |
|  <i class="fas fa-redo"></i>  |  redo   |  <kbd>Ctrl</kbd> <kbd>Y</kbd>   | 
|  <i class="fas fa-times"></i>  |  暂时关闭辅助工具条   |  

### 全屏

通过点击顶部工具条  <i class="fas fa-expand"></i> 图标，或者通过快捷键 <kbd>Ctrl</kbd> <kbd>Enter</kbd>进入全屏模式

在全屏模式下  
位于编辑器页面，通过 <kbd>Ctrl</kbd> <kbd>-></kbd>进入预览页面  
位于编辑器页面，通过 <kbd>Ctrl</kbd> <kbd>&lt;-</kbd>进入TOC页面  
位于预览页面，通过 <kbd>Ctrl</kbd> <kbd>&lt;-</kbd>进入编辑器页面  
位于TOC页面，通过 <kbd>Ctrl</kbd> <kbd>-></kbd>进入编辑器页面 
